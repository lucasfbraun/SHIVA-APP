...
INSERT INTO "new_produtos" ("ativo", "atualizadoEm", "categoria", "codigoBarras", "codigoInterno", "controlaEstoque", "criadoEm", "custoMedio", "descricao", "id", "imagemUrl", "markup", "nome", "precoVenda", "tipo") SELECT "ativo", "atualizadoEm", "categoria", "codigoBarras", "codigoInterno", "controlaEstoque", "criadoEm", "custoMedio", "descricao", "id", "imagemUrl", "markup", "nome", "precoVenda", "tipo" FROM "produtos";
DROP TABLE "produtos";
