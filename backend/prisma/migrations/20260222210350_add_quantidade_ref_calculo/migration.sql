...
CREATE TABLE "new_produtos" (
    ...
    "quantidadeRefCalculo" REAL NOT NULL DEFAULT 1,
...
INSERT INTO "new_produtos" ("ativo", "atualizadoEm", "categoria", "codigoBarras", "codigoInterno", "controlaEstoque", "criadoEm", "custoMedio", "descricao", "id", "imagemUrl", "markup", "nome", "precoVenda", "tipo", "unidadeMedida") SELECT "ativo", "atualizadoEm", "categoria", "codigoBarras", "codigoInterno", "controlaEstoque", "criadoEm", "custoMedio", "descricao", "id", "imagemUrl", "markup", "nome", "precoVenda", "tipo", "unidadeMedida" FROM "produtos";
DROP TABLE "produtos";
